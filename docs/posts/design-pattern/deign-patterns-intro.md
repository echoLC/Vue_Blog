...
除了设计模式给代码带来的一系列好处，学习设计模式，可以让初学者更加深入理解面向对象的思想。学完了设计模式，你可以知道：如何将代码分散在几个不同的类中？为什么要有“接口”？何谓针对抽象编程？何时不应该使用继承？如果不修改源代码增加新功能？同时还让你能够更好地阅读和理解现有类库与其他系统中的源代码。
<br>
<br>
